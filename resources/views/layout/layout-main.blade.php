...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="theme/img/Logo300x300.png" type="image/x-icon" />
...
<body>
	<div  style="background-color: #d3b7ea;" class="body">
											...
											<ul class=" nav nav-pills" id="mainNav">
												...
												<li class="dropdown">
													...
													<ul class="dropdown-menu">
														...
														<li><a href="success">ความสำเร็จในวิชาชีพ </a></li>
														<!-- <li><a href="benefit">คุณประโยชน์ต่อสังคม</a></li> -->
												...
												<li class="dropdown">
													...
													<ul class="dropdown-menu">
														<li><a href="shortcodes-accordions.html">วิสัยทัศน์ 2020</a></li>
														<li><a href="shortcodes-toggles.html">พันธกิจ</a></li>
		...
		<div style="background-color: #d3b7ea;">
			@yield('content')
		</div>
		<footer id="footer">
	...
	<!-- Examples -->
	<script src="theme/js/examples/examples.demos.js"></script>
